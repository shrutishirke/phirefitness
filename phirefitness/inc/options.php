...
function phirefitness_text_field_render() { 
  ...
  function phirefitness_textarea_field_render() { 
    $options = get_option( 'phirefitness_options_settings' );
    ?>
    <textarea cols="40" rows="5" name="phirefitness_options_settings[cd_textarea_field]"><?php if (isset($options['phirefitness_textarea_field'])) echo $options['phirfitness_textarea_field']; ?></textarea>
    <?php
  }
